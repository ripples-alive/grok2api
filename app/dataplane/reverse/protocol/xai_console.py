...
def convert_openai_tools_to_console(
...
def extract_console_search_sources(
    response_json: dict[str, Any],
) -> list[dict[str, Any]]:
...
def extract_console_annotations(
    response_json: dict[str, Any],
) -> list[dict[str, Any]]:
...
class ConsoleStreamAdapter:
    ...
    def feed_data(self, data: str) -> dict[str, Any]:
        ...
        if (
            ...
            or obj.get("type") == "response.output_text.delta"
        ):
        ...
        if (
            ...
            or obj.get("type") == "response.output_item.added"
        ):
        ...
        if (
            ...
            or obj.get("type") == "response.output_item.done"
        ):
            item = obj.get("item") or {}
        ...
        if (
            ...
            or obj.get("type") == "response.function_call_arguments.delta"
        ):
        ...
        if (
            ...
            or obj.get("type") == "response.function_call_arguments.done"
        ):
            item_id = obj.get("item_id") or ""
            idx = self._active_tool_index.get(item_id)
            if idx is None:
        ...
        if (
            ...
            or obj.get("type") == "response.output_text.annotation.added"
        ):
